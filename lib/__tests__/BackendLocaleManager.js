    ...
    describe(
      ...
      () => {
        const localeManager = new BackendLocaleManager({
          ...
          // See https://github.com/i18next/i18next/issues/865
          ...
          () => {
            ...
            it(
              ...
              () => {
                ...
                expect(mock.request.formatNumber(123456.7890)).toBe("123,457");
                expect(
                  mock.request.formatNumber(123456.7890, {precision: 2}),
                ).toBe("123,456.79");
              },
            );
          },
